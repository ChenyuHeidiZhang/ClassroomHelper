...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_pic_notes) {
            Intent intent = new Intent(MainActivity.this, PictureToNotesActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_equation_recognition) {
            Intent intent = new Intent(MainActivity.this, EquationRecognitionActivity.class);
            startActivity(intent);
